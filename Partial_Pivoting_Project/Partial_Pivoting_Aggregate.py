...
def simulation_plot_gen(data_gen_reqd):
    ...
    for i,size in enumerate(simulation_data.index.unique(level='size')):
        ...
        pivot_plot.boxplot([pivot_data_90, pivot_data_100], labels=['90-percentile', '100-percentile'])
        nonpivot_plot.boxplot([non_pivot_data_90, non_pivot_data_100], labels=['90-percentile', '100-percentile'])
